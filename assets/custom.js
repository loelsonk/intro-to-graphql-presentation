$(function() {
  var graphiqlUrl = "http://207.154.250.25:4000/graphql"
  ...
  var initGraphiQL = function (selector) {
    selector.map(function (idx, elem) {
      ...
      $('<iframe src="' + graphiqlUrl + '?zoom=' + graphiqlZoom + '&output=embed&query=' + encodeURIComponent(query) + '&response=' + encodeURIComponent(resp) + '&' + varsParam + '" class="graphiql">').insertAfter(replaceElem)
